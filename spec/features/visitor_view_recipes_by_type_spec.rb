...
feature 'Visitor view recipes by type' do
  ...
  scenario 'and view only recipes from same type' do
    ...
    main_recipe = Recipe.create(
      ...
      method: 'Frite o bacon; Cozinhe a massa ate ficar al dent; Misture os
              ovos e o bacon a massa ainda quente;')
    # simula a ação do usuário
    visit root_path
