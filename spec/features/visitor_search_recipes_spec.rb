...
feature 'Visitor search for recipes' do
  ...
  scenario 'and find all matches' do
    ...
    another_recipe = Recipe.create(
      ...
      method:
      'Bata todos os ingredientes no liquidificador e leve ao forno por 40 minutos.'
    )
  ...
  scenario 'and no results found' do
    ...
    another_recipe = Recipe.create(
      ...
      method:
      'Cozinhe o arroz, corte o salmão e a cebolinha. Coloque tudo no nori e enrole em formato de cone'
    )
    # simula a ação do usuário
    visit root_path
